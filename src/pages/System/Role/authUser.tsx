    ...
    <PageContainer>
      <div style={{ width: '100%', float: 'right' }}>
        <ProTable<API.System.User>
          ...
          request={(params) => allocatedUserList({ ...params, roleId } as API.System.RoleListParams).then((res) => {
            const result = {
              data: res.rows,
              total: res.total,
              success: true,
      ...
      <UserSelectorModal
        ...
        onSubmit={(values: React.Key[]) => {
          ...
          authUserSelectAll({ roleId, userIds }).then((resp) => {
        ...
        params={{ roleId }}
        request={(params) => unallocatedUserList({ ...params } as API.System.RoleListParams).then((res) => {
          const result = {
            data: res.rows,
