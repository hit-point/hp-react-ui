...
import { LoginForm, ProFormCaptcha, ProFormCheckbox, ProFormText, LoginFormPage } from '@ant-design/pro-components';
    ...
    <div className={containerClassName}>
      ...
      <div
        ...
        <LoginFormPage
          ...
          // logo={<img alt='logo' src='/icons/xxx.png' />}
          // title={<img style={{ width: '188px', height: '48px' }} src='/icons/xxx.png' /> as any}
          title="hp-react-ui"
          subTitle={intl.formatMessage({ id: 'pages.layouts.userLayout.title' })}
          backgroundImageUrl="/icons/loginBg.webp"
          initialValues={{
            autoLogin: true,
          }}
          // actions={[
